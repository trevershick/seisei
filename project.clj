...
(defproject seisei "0.1.6-SNAPSHOT"
            ...
            :resource {:resource-paths  ["bower_components/mousetrap/plugins/global-bind/"]
            ...
            :profiles       {:dev      {:plugins [[lein-figwheel "0.5.0-1"]]
                                        ...
                                        :cljsbuild {:test-commands {"unit" ["phantomjs" "src/phantom/test-driver.js" "resources/private/test-runner.html"]}
                                                    :builds {:dev {:source-paths ["src/main/cljs"]
                                                                   :figwheel true
                                                                   :compiler {:main         seisei.ui.main
                                                                              ...
                                                                              :verbose      true}}
                                                             :test {:source-paths ["src/main/cljs" "src/test/cljs"]
                             ...
                             :uberjar  {:aot :all
                                        :omit-source true
                                        :hooks [leiningen.cljsbuild]
                                        :cljsbuild ^:replace {:builds {:test nil
                                                                       :dev {:source-paths ["src/main/cljs"]
